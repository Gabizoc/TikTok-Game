			...
			<main className="max-w-5xl mx-auto py-6 px-4 lg:px-8">
				...
				>
					<div className="flex items-center mb-6">
						...
						<h2 className="text-xl font-semibold text-gray-100">{t('Profile')}</h2>
					</div>
				...
				>
					<div className="flex items-center mb-4">
						...
						<h2 className="text-xl font-semibold text-gray-100">{t("Notifications")}</h2>
					</div>
				...
				>
					<div className="flex items-center mb-4">
						...
						<h2 className="text-xl font-semibold text-gray-100">{t('Danger Zone')}</h2>
					</div>

					<p className="text-gray-300 mb-4">{t('Permanently delete your account and all of your content.')}</p>
