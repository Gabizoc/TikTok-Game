...
const GameCard = ({ title, description, launches, image, onLaunch }) => {
	...
	return (
			...
			<div className="px-4 py-5 flex flex-col justify-between flex-1">
				<div>
                <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-indigo-500 to-purple-600 mb-2" > {title} </h3>
					<p className="text-gray-400 text-sm">{description}</p>
				</div>

				<div className="flex items-center justify-between mt-4">
					<span className="text-pink-400 font-bold">{launches} {t('launches')}</span>
                    <motion.button
