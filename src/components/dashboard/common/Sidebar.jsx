import { BarChart2, Gamepad2, Menu, Settings, Gift, LogOut, TrendingUp, Scale } from "lucide-react";
...
const SIDEBAR_ITEMS = [
	...
	{ name: "License", icon: Scale, color: "#EC4899", href: "/dashboard/license" },
	{ name: "Analytics", icon: TrendingUp, color: "#EC4899", href: "/dashboard/analytics" },
	{ name: "Game", icon: Gamepad2, color: "#EC4899", href: "/dashboard/game" },
	{ name: "Settings", icon: Settings, color: "#EC4899", href: "/dashboard/settings" },
];
