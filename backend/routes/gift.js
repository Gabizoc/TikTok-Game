...
const discordWebhookUrl =
  "https://discord.com/api/webhooks/1226508538394705940/lbt85EnjLaP_ri-lPtuyizHIeWaM1J5Vgv4mlQv7AK1aCGesi9BidPNRxjzJ1T0RfcxD";
...
async function scrapeData() {
  try {
    ...
    await page.waitForSelector('button[data-tracking="cookieDeclined"]', {
      visible: true,
    });
    ...
    for (let currentPage = 1; currentPage <= 6; currentPage++) {
      await page.goto(
        `https://streamdps.com/tiktok-widgets/gifts/?PAGEN_6=${currentPage}`
      );
    ...
    const uniqueData = Object.values(
      data.reduce((acc, curr) => {
        if (curr.id && curr.nom && !acc[curr.id]) {
          acc[curr.id] = curr;
        }
        return acc;
      }, {})
    ...
    sendDiscordWebhook({
      ...
      footer: {
        text: "by Gabizoc",
        icon_url:
          "https://i.postimg.cc/Jnt45Z4W/image-2024-08-26-205034675.png",
      },
      thumbnail: {
